...
Definition idf {catC: Category} {a b: catC} (f: arrow catC b a) := f.
...
Definition coq_comp_on_objects (catC catD catE: Category) (F: catC -> catD) (G: catD -> catE) (a: catC) := G (F a).
Definition coq_comp_on_morphism (catC catD catE: Category) (F: catC -> catD) (G: catD -> catE) 
                                ...
                                (a b: catC) (f: (arrow catC b a)) := fmapG _ _ (fmapF _ _ f).
...
Proof. refine(@mk_Functor
               catC
               catD _ _ _ _
             ). intros. reflexivity. intros. simpl. rewrite identity_f; reflexivity.
Defined.
